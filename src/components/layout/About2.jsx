  ...
  return (
    <>
      ...
      >
        ...
        <article className="relative z-50 text-balance h-full flex flex-col justify-center gap-12 px-6  md:gap-20 md:h-full lg:w-1/2   ">
      ...
      <section className="relative h-[90dvh] md:h-screen w-full flex justify-center items-center bg-zinc-800 overflow-hidden xl:bg-red-500">
        ...
        <article className="flex flex-col w-full justify-center items-center text-center relative z-10 px-2 gap-9 md:gap-16">
